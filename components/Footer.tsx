...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white border-t mt-12 py-12 text-gray-600">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {quickLinks.map((link, idx) => (
                <li key={idx}>
                  <Link to={link.path} className="hover:text-green-500">{link.name}</Link>
                </li>
              ))}
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {supportLinks.map((link, idx) => (
                <li key={idx}>
                  <a href={link.path} className="hover:text-green-500">{link.name}</a>
                </li>
              ))}
            </ul>
          </div>
        </div>
        <div className="border-t mt-12 pt-8 text-center text-xs">
